...
-- CreateIndex
CREATE UNIQUE INDEX "User_userPreferanceId_key" ON "User"("userPreferanceId");
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_userPreferanceId_fkey" FOREIGN KEY ("userPreferanceId") REFERENCES "UserPreferance"("id") ON DELETE SET NULL ON UPDATE CASCADE;
